...
\end{enumerate}
This way, we do not have to keep track of lower-dimensional cones during decomposition.
...
covers at most $1$ unit of the line segment between $u_1$ and $u_2$.
...
the number of leaves of the tree -- which is equal to the number of unimodular cones in the final decomposition -- is bounded by
\[
...
Equivalently, one might represent them as $Ax \leq 0$.
...
\]
With $M := \max_j \|u_j\|_\infty$, where $u_j$ are the generators of the initial cone $C$,
